...
| :--- | :--- | :--- |
| **[Gnomon (Startup)](https://github.com/JaoVile)** | **Co-Founder & Tech Lead**<br>Aplicação PWA de mapeamento indoor. | `React`, `TypeScript`, `Algoritmos de Rotas` |
| **[Sede Digital (Portfólio)](https://joaovilela.vercel.app)** | **Engenheiro Front-end**<br>OS Web simulado com alta performance (SEO 100). | `Next.js`, `Bento Grid`, `Framer Motion` |
